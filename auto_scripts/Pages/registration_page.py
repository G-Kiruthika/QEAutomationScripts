...
class RegistrationPage(BasePage):
    ...
    # --- Appended missing locators as per metadata ---
    ...
    # --- Appended missing methods as per metadata ---
    def register_user(self, email, password, name):
        self.enter_text(self.EMAIL_INPUT_PLACEHOLDER, email)
        self.enter_text(self.PASSWORD_INPUT_PLACEHOLDER, password)
        self.enter_text(self.NAME_INPUT_PLACEHOLDER, name)
        self.click_element(self.REGISTER_BUTTON_PLACEHOLDER)
