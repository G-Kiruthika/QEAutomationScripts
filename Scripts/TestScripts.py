...
class TestLoginFunctionality:
    ...
    def test_TC_LOGIN_003(self):
        ...
        4. Assert that username is retrieved.
        """
        self.login_page.load()
        self.login_page.click_forgot_username()
        test_email = 'testuser@example.com'  # Replace with a valid test email
        recovered_username = self.login_page.recover_username(test_email)
        assert recovered_username is not None and recovered_username != '', 'Username recovery failed or returned empty.'
